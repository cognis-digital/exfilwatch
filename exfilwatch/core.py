"""EXFILWATCH core — Detect DNS/HTTP exfiltration patterns (entropy, beaconing) in logs."""
...
RULES = [
    ("EXF-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("EXF-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("EXF-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
