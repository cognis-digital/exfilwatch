#!/usr/bin/env sh
# Universal installer for exfilwatch. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/exfilwatch.git"
echo "Installing exfilwatch ..."
